# Portfolio QA – Jenniffer Lorente  
...
🔗 [Ver Web Portfolio QA](https://jennifferqaorganization.github.io/Portafolio-QA.plantilla/)
...
- Proyecto Supabase (requiere acceso): [Supabase Project](https://supabase.com/dashboard/project/pndukgwodcofmrxnwzwd)  

## 🗄 API de Formulario
Se ha generado una API que permite agregar, editar, consultar y eliminar datos de la base de datos creada en supabase.
- URL API (requiere acceso): [Supabase API](https://pndukgwodcofmrxnwzwd.supabase.co/rest/v1/form)  
- Documentación de la API: [Documentación API](https://github.com/JennifferQAOrganization/Portafolio-QA.plantilla/blob/main/apidocs.html) 
---
...
### Pruebas de API
- Colección en POSTMAN (requiere acceso): [POSTMAN Collection](https://jlr4444-131526.postman.co/workspace/form~0d9eeb1d-5b7d-4760-ae88-8997d29a3cbc/collection/53456707-8282ccf5-2ca6-497b-9ba5-ab9108d7e180?action=share&source=copy-link&creator=53456707) 
...
## 👩‍💻 Autora
**Jenniffer Lorente – QA Senior**  
[🔗 LinkedIn](https://www.linkedin.com/in/jenniffer-lorente-47b287113/)
